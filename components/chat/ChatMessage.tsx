...
const ChatMessage: React.FC<ChatMessageProps> = ({ message }) => {
  ...
  return (
    <div
      className={`
        group flex gap-4 px-4 py-6 w-full
      ...
      <div className="max-w-3xl mx-auto w-full flex gap-4">
        ...
        <div className="flex-shrink-0">
          {isUser ? (
            ...
            <div className="w-9 h-9 rounded-sm bg-[#10A37F] flex items-center justify-center">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="text-[#D1D5DB] leading-7 whitespace-pre-wrap break-words">
            {message.content}
          </div>
          {message.chartConfig && (
