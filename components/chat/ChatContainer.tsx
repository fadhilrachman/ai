      ...
      <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-600">
        {messages.length === 0 ? (
          ...
          <div className="min-h-full flex flex-col items-center justify-center px-4 py-12 md:py-8">
            <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-[#10A37F] flex items-center justify-center mb-6 shadow-lg shadow-[#10A37F]/20">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <p className="text-[#8E8EA0] text-center mb-8 max-w-sm md:max-w-md text-sm md:text-base">
              I&apos;m your AI assistant. Ask me anything about your documents or any other topic.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-3 w-full max-w-2xl">
              {suggestedPrompts.map((prompt, index) => (
                <Button
                  ...
                  className={`
                    !h-auto !p-3 md:!p-4 !rounded-xl !text-left
                    !bg-[#40414F] hover:!bg-[#4E4F60]
                    !border !border-[#565869] hover:!border-[#6E6E80]
                    transition-all duration-200
                    flex items-center md:items-start gap-3
                  `}
                >
                  <span className="text-lg md:text-xl">{prompt.icon}</span>
                  <div className="flex flex-col">
                    <span className="font-medium text-xs md:text-sm">{prompt.title}</span>
                    <span className="text-[#8E8EA0] text-[10px] md:text-xs">
                      {prompt.subtitle}
                    </span>
                  </div>
                </Button>
            ...
            {isLoading && (
              <div className="flex gap-4 px-4 py-6 bg-[#343541]">
                <div className="max-w-3xl mx-auto w-full flex gap-4">
                  <div className="w-8 h-8 md:w-9 md:h-9 rounded-sm bg-[#10A37F] flex items-center justify-center flex-shrink-0">
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 24 24"
                  ...
                  <div className="flex items-center gap-1">
                    <div className="w-1.5 h-1.5 bg-[#8E8EA0] rounded-full animate-bounce" style={{ animationDelay: "0ms" }} />
                    <div className="w-1.5 h-1.5 bg-[#8E8EA0] rounded-full animate-bounce" style={{ animationDelay: "150ms" }} />
                    <div className="w-1.5 h-1.5 bg-[#8E8EA0] rounded-full animate-bounce" style={{ animationDelay: "300ms" }} />
                  </div>
                </div>
              </div>
            )}
